...
export const Register = () => {
  ...
  return (
    <div className="px-[6vw] py-10">
      ...
      {/* <div className="bg-red-50 border border-red-300 flex items-center gap-6 px-6 py-3 mt-4 rounded">
        <Icon
          name="warning"
        ...
        <div>
          ...
          <div className="text-lg text-red-600 font-bold mt-1">
            Les quittances du concours précédent ne seront pas considérées comme
            valides pour la participation au concours actuel.
          </div>
        </div>
      </div> */}
      <Form>
